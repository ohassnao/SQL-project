	...
	<div class="container col-lg-11 ">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  	  <a href="adddocument.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add DOC</button></a>
		  ...
		  <table class="table table-bordered">
		          ...
		          <tbody> 
		            <tr> 
					 ...
					 <td>
		             	<form action="updatedocument.php" method="post">
		             		<input type="hidden">
		             		<td><button class="btn btn-warning"><a href="updatedocument.php?ID_DOC=<?php echo $row["ID_DOC"]; ?>">Update</a></button></td>
